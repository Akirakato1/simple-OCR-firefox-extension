...
assert.equal(manifest.browser_action.default_icon['16'], 'icons/ocr-o.svg');
assert.equal(manifest.browser_action.default_icon['32'], 'icons/ocr-o.svg');
assert.equal(manifest.browser_action.default_icon['48'], 'icons/ocr-o.svg');
assert.equal(manifest.icons['48'], 'icons/ocr-o.svg');
assert.equal(manifest.icons['96'], 'icons/ocr-o.svg');
